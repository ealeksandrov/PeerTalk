...
/usr/local/bin/mogenerator --model "${INPUT_FILE_PATH}/$curVer" --machine-dir "${PROJECT_DIR}/Classes/DataModel/CoreDataModels/Private/" --human-dir "${PROJECT_DIR}/Classes/DataModel/CoreDataModels/" --template-var arc=true
