...
/usr/local/bin/mogenerator --model "${INPUT_FILE_PATH}" --machine-dir "${PROJECT_DIR}/Classes/DataModel/CoreDataModels/Private/" --human-dir "${PROJECT_DIR}/DataModel/Classes/CoreDataModels/" --template-var arc=true
